...
import { chatShapeSchema } from './schemas/chatShapeSchema'

// Add custom shapes to the schema
  ...
  getRoom() {
    ...
    if (!this.roomPromise) {
      this.roomPromise = (async () => {
        ...
        // create a new TLSocketRoom using our schema with the custom chat shape
        return new TLSocketRoom<TLRecord, void>({
          schema,
          initialSnapshot,
          onDataChange: () => {
            // and persist whenever the room changes
